...
// این کد را بهش اضافه کردیم
	if jalaaliMonth > 12  || jalaaliMonth < 0 {
		return 0, 0, 0, errors.New("invalid jalaali month")
	}
	
	if jalaaliDay > 31 || jalaaliDay < 0 {
		return 0, 0, 0, errors.New("invalid jalaali day")
	}
